            ...
            <div class="w-1/3 ml-20">
                    ...
                    <div class="w-full flex">
                        <select name="ProductModelName" id="product-model-name"
                            ...
                            @foreach ($models as $model)
                                <option value="{{ $model->ProductModelId }}">{{ $model->ProductModelName }}</option>
                            @endforeach
                        </select>
                        <button type="button" class="bg-green-500 rounded-tr-lg border border-green-500 rounded-br-lg hover:bg-green-600 text-white font-bold h-10 w-36 px-2" data-modal-target="product-model-create-modal" data-modal-toggle="product-model-create-modal">
                ...
                <div class="mt-3">
                    ...
                    <div class="relative w-full">
                        <input type="number" id="unit-price" min="0"
                            class="block px-3 w-full h-10 border border-black rounded-lg" placeholder="" required />
                        <div class="absolute inset-y-0 end-11 flex items-center ps-3 pointer-events-none">
                            vnđ
                        </div>
                    </div>
                </div>
                <div class="mt-3">
                    ...
                    <textarea name="DesignSizeAndWeight" id="design-size-and-weight" rows="3"
                        class="pt-1 px-3 w-full border border-black rounded-lg"></textarea>
                </div>
                ...
                <div class="mt-3">
                    ...
                    <input type="number" id="inventory" name="Inventory" value="" required
                        class="px-3 w-full h-10 border border-black rounded-lg">
                </div>
