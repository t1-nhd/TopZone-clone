    ...
    <div class="container mx-auto px-4">
        <div class="py-8">
            ...
            <div class="flex w-full justify-between">
                ...
                <a href="{{ route('products.edit', $product->ProductId) }}" class="text-blue-500 mt-2">Chỉnh sửa</a>
            </div>
            <div class="flex w-full">
                ...
                <div class="w-1/2 bg-white shadow h-screen overflow-auto sm:rounded-lg ml-3">
                    <div class="px-4 py-5 sm:px-6">
