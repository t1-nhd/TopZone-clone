...
@section('content')
    <div class="w-screen h-screen bg-gradient-to-b from-black to-gray-400 flex flex-col justify-center">
        <div class="flex justify-center">
            <div class="flex min-h-full mt-5 flex-col justify-center px-6 py-3 w-full mx-6 md:mx-0 md:w-[500px] lg:px-8 bg-gray-100 rounded-lg shadow-md">
                <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                    <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Đăng ký tài khoản
                        mới
                    </h2>
                </div>
                    ...
                    <form class="space-y-4" action="{{ route('registration') }}" method="POST">
                        ...
                        <div class="flex">
                            <div class="w-1/4 flex-col items-center">
                                <div class="mr-1">
                                    <label for="gender"
                                        class="block text-sm font-medium leading-6 text-gray-900 invisible">Giới
                                        tính:</label>
                        ...
                        <div>
                            <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Email địa
                                chỉ</label>
                        ...
                        @if (session('email-exist'))
                            <div>
                                <div
                                    class="bg-red-100 border border-red-500 text-red-700 p-4 transition-opacity duration-500 pb-3">
                        ...
                        <div>
                            <label for="confirm-password" class="block text-sm font-medium leading-6 text-gray-900">Xác nhận
                                mật
                                khẩu</label>
